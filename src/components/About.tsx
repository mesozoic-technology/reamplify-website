  ...
  return (
    <section id="about" className="relative py-24 bg-transparent overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div>
            <h2 className="text-[#5EFFD3] mb-6 text-4xl brightness-125" style={{ 
              textShadow: '0 0 40px rgba(94, 255, 211, 0.8)' 
            }}>
              Why (RE) - Amplify?
            </h2>
            <p className="text-[#5EFFD3] text-lg mb-6 brightness-100" style={{
            ...
            <p className="text-[#5EFFD3] text-lg mb-8 brightness-100" style={{
              textShadow: '0 0 20px rgba(94, 255, 211, 0.4)'
            }}>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-[#5EFFD3] mb-1 text-lg brightness-110" style={{
                    textShadow: '0 0 20px rgba(94, 255, 211, 0.4)'
                  }}>Institutional Security</h4>
                  <p className="text-[#5EFFD3] text-base brightness-90" style={{
